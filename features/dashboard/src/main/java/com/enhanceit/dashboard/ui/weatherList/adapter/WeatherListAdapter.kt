...
class WeatherListAdapter(
...
) : ListAdapter<WeatherInfo, WeatherListAdapter.OfflineDriverViewHolder>(
    DiffCallback()
) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OfflineDriverViewHolder =
        OfflineDriverViewHolder(
    ...
    override fun onBindViewHolder(holder: OfflineDriverViewHolder, position: Int) {
        getItem(position)?.let { holder.bind(it) }
    }

    inner class OfflineDriverViewHolder(
